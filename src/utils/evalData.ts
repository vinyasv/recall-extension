...
export const EVAL_QUERIES: EvalQuery[] = [
  ...
  // === Hybrid Search Tests: Keyword-Heavy Queries ===
  {
    query: "github",
    description: "KEYWORD TEST: Exact domain match - should find GitHub Actions",
    expectedUrls: [
      "https://docs.github.com/en/actions",
    ],
    relevance: {
      "https://docs.github.com/en/actions": 5,
      "https://docs.docker.com/get-started/": 1,
      "https://kubernetes.io/docs/tutorials/": 1,
    }
  },
  {
    query: "stackoverflow python",
    description: "KEYWORD TEST: Domain + keyword match",
    expectedUrls: [
      "https://stackoverflow.com/questions/tagged/python",
    ],
    relevance: {
      "https://stackoverflow.com/questions/tagged/python": 5,
      "https://www.python.org/doc/": 3,
    }
  },
  {
    query: "React.useEffect",
    description: "KEYWORD TEST: Exact technical term with punctuation",
    expectedUrls: [
      "https://react.dev/reference/react/hooks",
      "https://react.dev/learn",
    ],
  ...
  {
    query: "tensorflow.js",
    description: "KEYWORD TEST: Exact library name with dot",
    expectedUrls: [
      "https://www.tensorflow.org/js",
    ],
    relevance: {
  ...
  {
    query: "pytorch tutorials",
    description: "KEYWORD TEST: Brand name + keyword",
    expectedUrls: [
      "https://pytorch.org/tutorials/",
    ],
    relevance: {
      "https://pytorch.org/tutorials/": 5,
      "https://www.tensorflow.org/tutorials": 2,
      "https://keras.io/guides/": 2,
    }
  },
  {
    query: "FastAPI",
    description: "KEYWORD TEST: Exact brand name (case insensitive)",
    expectedUrls: [
      "https://fastapi.tiangolo.com/",
    ],
    relevance: {
      "https://fastapi.tiangolo.com/": 5,
      "https://flask.palletsprojects.com/": 1,
    }
  },
  {
    query: "openai gpt-4",
    description: "KEYWORD TEST: Brand + model name",
    expectedUrls: [
      "https://platform.openai.com/docs/",
    ],
    relevance: {
  ...
  },
  {
    ...
    description: "KEYWORD TEST: Tool + command phrase",
    expectedUrls: [
      "https://docs.docker.com/get-started/",
    ],
    relevance: {
      "https://docs.docker.com/get-started/": 5,
      "https://kubernetes.io/docs/tutorials/": 2,
    }
  },
  {
    query: "w3schools html tutorial",
    description: "KEYWORD TEST: Brand + exact phrase",
    expectedUrls: [
      "https://www.w3schools.com/html/",
    ],
    relevance: {
      "https://www.w3schools.com/html/": 5,
      "https://developer.mozilla.org/en-US/docs/Web/JavaScript": 2,
    }
  },
  {
    query: "nginx documentation",
    description: "KEYWORD TEST: Brand + generic term",
    expectedUrls: [
      "https://nginx.org/en/docs/",
    ],
    relevance: {
      "https://nginx.org/en/docs/": 5,
      "https://www.python.org/doc/": 1,
    }
  },
  {
    query: "mdn javascript",
    description: "KEYWORD TEST: Acronym + language",
    expectedUrls: [
      "https://developer.mozilla.org/en-US/docs/Web/JavaScript",
    ],
    relevance: {
      "https://developer.mozilla.org/en-US/docs/Web/JavaScript": 5,
      "https://www.w3schools.com/html/": 2,
    }
  },
  {
    query: "redis cache",
    description: "KEYWORD TEST: Brand + use case",
    expectedUrls: [
      "https://redis.io/documentation",
    ],
    relevance: {
  ...
  {
    query: "graphql learn",
    description: "KEYWORD TEST: Tech + action word",
    expectedUrls: [
      "https://graphql.org/learn/",
    ],
    relevance: {
      "https://graphql.org/learn/": 5,
      "https://fastapi.tiangolo.com/": 1,
    }
  },
  {
    query: "aws lambda serverless",
    description: "HYBRID TEST: Brand + technical term + concept",
    expectedUrls: [
      "https://docs.aws.amazon.com/lambda/",
    ],
    relevance: {
      "https://docs.aws.amazon.com/lambda/": 5,
      "https://developer.hashicorp.com/terraform/docs": 2,
    }
  },
  {
    query: "nextjs server side rendering",
    description: "HYBRID TEST: Brand + technical description",
    expectedUrls: [
      "https://nextjs.org/docs",
    ],
    relevance: {
      "https://nextjs.org/docs": 5,
      "https://react.dev/learn": 3,
      "https://vuejs.org/guide/": 1,
    }
  },
  {
    query: "tailwind css utility classes",
    description: "HYBRID TEST: Brand + defining feature",
    expectedUrls: [
      "https://tailwindcss.com/docs",
    ],
    relevance: {
  ...
  },
  {
    ...
    description: "HYBRID TEST: Library + core concept + action",
    expectedUrls: [
      "https://pandas.pydata.org/docs/",
    ],
    relevance: {
  ...
  },
  {
    ...
    description: "HYBRID TEST: Brand + category",
    expectedUrls: [
      "https://www.rust-lang.org/learn",
    ],
    relevance: {
      "https://www.rust-lang.org/learn": 5,
      "https://www.python.org/doc/": 2,
    }
  },
];
